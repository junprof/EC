...
namespace cn.jpush.api.push.mode
{
    public class Notification 
	{
        ...
        [JsonIgnore]
        public Dictionary<String, object> extras { get; protected set; } = new Dictionary<string, object>();
        ...
        public Notification setExtras(Dictionary<String, object> extras)
        {
            this.extras = extras;
            return this;
        }
        ...
        public Notification setAlert(string alert, Dictionary<String, object> extras)
        {
            this.alert = alert;
