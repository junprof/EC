...
namespace DTcms.DAL
{
    ...
    public partial class dt_feedback
    {
        ...
        public int Add(DTcms.Model.dt_feedback model)
        {
            ...
            strSql.Append("title,content,addtime,managerid,isdel)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@ManagerId", SqlDbType.Int,10),
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update from dt_feedback set isdel=1");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)
            };
        ...
        public DTcms.Model.dt_feedback GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,title,content,addtime,managerid,isdel from dt_feedback ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)
            };
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,title,content,addtime,managerid,isdel ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" i.*,m.user_name ");
            strSql.Append(" FROM dt_feedback i left join dt_manager m on i.managerid=m.id ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from dt_feedback T ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select i.*,m.user_name,m.real_name FROM dt_feedback i left join dt_manager m on i.managerid=m.id  ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
