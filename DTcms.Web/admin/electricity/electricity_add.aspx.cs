...
namespace DTcms.Web.admin.electricity
{
    public partial class electricity_add : ManagePage
    {
        ...
        private int DoAdd()
        {
            ...
            model.position = "";
            model.remarks = "";
            model.trailerAI = decimal.Parse(tbtrailerAI.Text.Trim());
            model.warningAI = decimal.Parse(tbwarningAI.Text.Trim());
            model.trailerBI = decimal.Parse(tbtrailerBI.Text.Trim());
            model.warningBI = decimal.Parse(tbwarningBI.Text.Trim());
            model.trailerCI = decimal.Parse(tbtrailerCI.Text.Trim());
            model.warningCI = decimal.Parse(tbwarningCI.Text.Trim());
            model.trailerLI = decimal.Parse(tbtrailerLI.Text.Trim());
            model.warningLI = decimal.Parse(tbwarningLI.Text.Trim());
            model.trailerOneTemperature = decimal.Parse(tbtrailerOneTemperature.Text.Trim());
            model.warningOneTemperature = decimal.Parse(tbwarningOneTemperature.Text.Trim());
            model.trailerTwoTemperature = decimal.Parse(tbtrailerTwoTemperature.Text.Trim());
            model.warningTwoTemperature = decimal.Parse(tbwarningTwoTemperature.Text.Trim());
            model.trailerThreeTemperature = decimal.Parse(tbtrailerThreeTemperature.Text.Trim());
            model.warningThreeTemperature = decimal.Parse(tbwarningThreeTemperature.Text.Trim());
            model.trailerFourTemperature = decimal.Parse(tbtrailerFourTemperature.Text.Trim());
            model.warningFourTemperature = decimal.Parse(tbwarningFourTemperature.Text.Trim());
