...
<div class="tab-content">
  ...
  <dl>
    <dt>姓名</dt>
    <dd><asp:TextBox ID="txtRealName" runat="server" CssClass="input normal"></asp:TextBox>
    </dd>
  </dl>
  <dl>
    <dt>电话</dt>
    <dd><asp:TextBox ID="txtTelephone" runat="server" CssClass="input normal"></asp:TextBox>
        <span class="Validform_checktip">*最多放3个号码，用英文状态的逗号隔开，用于预警短信</span>
    </dd>
  </dl>
  <dl>
    <dt>邮箱</dt>
