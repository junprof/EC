...
<body class="loginbody">
    <form id="form1" runat="server">
        ...
        <div class="login-wrap" style="z-index:99;">
            <div class="login-logo" style="width:auto ; height:100px; background:url(skin/default/sysLogo.png) no-repeat center center; margin:0;">LOGO</div>
        ...
        <div class="copy-right">
            <p>版权所有 温州电信 Copyright © 2017 All Rights Reserved.</p>
        </div>
    </form>
</body>
</html>
