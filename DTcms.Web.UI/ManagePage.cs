...
namespace DTcms.Web.UI
{
    public class ManagePage : System.Web.UI.Page
    {
        ...
        public static List<Model.dt_area_code> arealist = null;
        ...
        /// <param name="nav_name">菜单名称</param>
        /// <param name="action_type">操作类型</param>
        public bool ChkAdminLevel_s(string nav_name, string action_type)
        {
            Model.manager model = GetAdminInfo();
            BLL.manager_role bll = new BLL.manager_role();
            bool result = bll.Exists(model.role_id, nav_name, action_type);
        ...
        /// <param name="msgtitle">提示文字</param>
        /// <param name="url">返回地址</param>
        protected void JscriptMsg_Parent(string msgtitle, string url)
        {
            string msbox = "jsprint_s(\"" + msgtitle + "\", \"" + url + "\")";
            ClientScript.RegisterClientScriptBlock(Page.GetType(), "JsPrint", msbox, true);
            //string msbox = "parent.jsprint_s(\"" + msgtitle + "\", \"" + url + "\")";
            //ClientScript.RegisterClientScriptBlock(Page.GetType(), "JsPrint", msbox, true);
        }
        #endregion
